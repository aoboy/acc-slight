...
//static const uint8_t periods_vec [] = {250, 180, 167, 150, 150, 133, 100}; //x100
static const uint8_t periods_vec [] = {200, 200, 200, 200, 200, 200 }; //x100
///=========================================================================/
#define GROUP_MERGE_SIZE 2
