...
struct nodelist_item{
    ...
    uint8_t  updated;    //used to check if slot gain was updated..
    ...
    uint8_t tmp_div;     //temporal diversity
    uint8_t spat_sim;    //spatial similarity
    uint16_t slot_gain;   //slot gain
};
///#if CONF_NETWORK_SIZE != 0 && 
...
///=========================================================================/
///=========================================================================/
//#define DATAPKT_HDR_LEN (4*sizeof(uint8_t))
#define DATA_PACKET_SIZE sizeof(data_packet_t)
#define DATAPKT_HDR_LEN (DATA_PACKET_SIZE - NETWORK_PAYLOAD_SIZE)
///=========================================================================/
///=========================================================================/
enum{
  SYNCH_PKT    = 0,
